...
def read_changelog(filepath: str) -> List[str]:
    ...
    Returns:
        The changelog lines.
    """
    with open(filepath, "r", encoding="utf-8") as changelog_file:
...
def write_changelog(filepath: str, lines: List[str]) -> None:
    ...
    """
    with open(filepath, "w", encoding="utf-8") as changelog_file:
...
@duty(pre=["check_code_quality", "check_docs", "check_dependencies"])
